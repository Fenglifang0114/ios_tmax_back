...
var (
	...
	READ_EEPROM_CMD_256_TMAX []byte = []byte{0x5a, 0xa5, 0x00, 0x11, 0xf1, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x97, 0xab, 0x7f, 0x0d, 0xa5, 0x5a} //20240124@FLF
...
func ComposeCmdTMAX(composer *m.CmdComposer, cmd m.CmdType, cmdData m.CmdData) ([]byte, int, error) {
	...
	case m.CMD_READ_EEPROM_256:
		return READ_EEPROM_CMD_256_TMAX, CMD_TIMEOUT_SHORT_100_MS, nil //20230926@FLF
